...
def make_CMB_T_map_visualise_steps(N,pix_size,ell,DlTT):
...
def Plot_CMB_Contour_Map(Map_to_Plot,c_min,c_max,X_width,Y_width):
...
## make a CMB T map
CMB_T = make_CMB_T_map_visualise_steps(N,pix_size,ell,DlTT)
Plot_CMB_Contour_Map(CMB_T,c_min,c_max,X_width,Y_width)
